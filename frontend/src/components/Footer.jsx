    ...
    <footer className="mt-16 pt-8 pb-6 bg-white/5 backdrop-blur-xl border-t border-white/10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-6 text-sm">
          ...
          <a href="https://github.com/nitinbajpaii" target="_blank" className="hover:text-purple-400 transition-all hover:scale-125 hover:-rotate-12" rel="noreferrer" aria-label="GitHub">
          ...
          <a href="https://www.linkedin.com/in/nitinbajpaii" target="_blank" className="hover:text-purple-400 transition-all hover:scale-125 hover:rotate-12" rel="noreferrer" aria-label="LinkedIn">
